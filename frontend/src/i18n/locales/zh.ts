  ...
  translation: {
    ...
    app2fa: {
      verify: {
        ...
        backupTitle: '使用备用码',
        backupDescription: '请输入一个未使用的备用码。',
      ...
      setup: {
        title: '设置双重验证',
        introDescription: '每次解锁时要求输入验证器中的动态验证码，为您的数据增加一道安全防线。',
        requirement1: '您需要一个验证器应用（例如 Google Authenticator、Authy）',
        requirement2: '请将备用码保存在安全的地方',
        startButton: '开始设置',
        scanDescription: '使用验证器应用扫描此二维码，或手动输入密钥。',
        showSecret: '显示密钥',
        hideSecret: '隐藏密钥',
        nextButton: '下一步',
        verifyDescription: '输入验证器应用中显示的6位数代码以验证设置。',
        verifyButton: '验证并启用',
        verifyError: '验证码无效，请确保您的验证器应用已正确设置。',
        backupDescription: '请保存这些备用码。每个备用码只能使用一次。请将它们存放在安全的地方。',
        backupWarning: '这些备用码将不会再次显示，请确保现在保存它们！',
      ...
      disable: {
        title: '禁用双重验证',
        description: '要禁用双重验证，请输入主密码和验证器应用中的TOTP代码以验证您的身份。',
